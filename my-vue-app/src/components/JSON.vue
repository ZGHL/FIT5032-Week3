...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id" :class="{ highlighted: author.name === 'George Orwell' }">
      ...
      <!-- TODO: CODE TO RENDER LIST OF AUTHORS HERE -->
      <ul>
        <li v-for="author in modernAuthors" :key="author.id" :class="{ highlighted: author.name === 'George Orwell' }">
          {{author.name}}
        </li>
      </ul>
      ...
      <ul>
        ...
        <li v-for="title in allFamousWorks">
          {{title}}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p>
        ...
        {{bookstores.totalStores.toString()}}
      </p>
    ...
    <section class="lab-section">
      ...
      <p class=highlighted>{{orwell.name}}</p>
    </section>
  </div>
</template>
